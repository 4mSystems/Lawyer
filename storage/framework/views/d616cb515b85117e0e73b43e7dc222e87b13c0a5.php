    ...
    <td class="center">
        <div class="visible-md visible-lg hidden-sm hidden-xs">
            ...
            <a id="editMohdar" class="btn btn-xs btn-blue tooltips" data-placement="top"
               data-original-title="Edit" data-moh-Id="<?php echo e($mohdar->moh_Id); ?>"><i class="fa fa-edit"></i></a>
            ...
            <a id="showMohdar" class="btn btn-xs btn-blue tooltips" data-placement="top"
               data-original-title="show" data-moh-Id="<?php echo e($mohdar->moh_Id); ?>"><i class="fa fa-eye-slash"></i></a>
        </div>
...
<?php /**PATH C:\xampp\htdocs\LawerWeb\resources\views/mohdareen/mohdareen_item.blade.php ENDPATH**/ ?>