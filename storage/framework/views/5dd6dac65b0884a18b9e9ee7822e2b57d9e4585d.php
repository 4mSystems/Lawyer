                ...
                <div class="toolbar row" style="direction:rtl;">
                    <div class="col-sm-12 hidden-xs">
                        <div class="page-header">
                            <h3 class="text-bold"><?php echo e(trans('site_lang.search_case_attachments')); ?></h3>
                        </div>
                    </div>
                </div>
                <!-- end: TOOLBAR -->
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dgmevmh7hnpa/public_html/Lawyer/resources/views/attachment/index.blade.php ENDPATH**/ ?>