                ...
                <div class="toolbar row" style="direction:rtl;">
                    <div class="col-sm-12 hidden-xs">
                        <div class="page-header">
                            <h3 class="text-bold"><?php echo e(trans('site_lang.client_attachments')); ?></h3>
                        </div>
                    </div>
                </div>
                <!-- end: TOOLBAR -->
                    ...
                    <div class="col-md-12"><br>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <a href="<?php echo e(url('clientattachment/'.$client_id.'/create')); ?>"
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-hover table-full-width"
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $client_attachment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case_attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="hidden-xs center">
                                                <?php if(!empty($case_attachment->img_Url)): ?>
                                                    ...
                                                    ?>
                                                    <?php if(! in_array( mime_content_type('uploads/client/attachments/'.$case_attachment->img_Url), $allowedMimeTypes)): ?>
                                                        <a href="<?php echo e(url('uploads/client/attachments/'.$case_attachment->img_Url)); ?>"
                                                           target="_blank"> <img
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('uploads/client/attachments/'.$case_attachment->img_Url)); ?>"
                                                           target="_blank"> <img
                                                                src="<?php echo e(url('uploads/client/attachments/'.$case_attachment->img_Url)); ?>"
                                            ...
                                            <td class="hidden-xs center"><a class='btn btn-raised btn-primary btn-sml'
                                                                            href=" <?php echo e(url('clientattachment/'.$case_attachment->id.'/edit')); ?>"><i
                                                        class="fa fa-edit"></i><?php echo e(trans('site_lang.public_edit_btn_text')); ?>

                                                </a>


                                                <form method="get" id='delete-form'
                                                      action="<?php echo e(url('clientattachment/'.$case_attachment->id.'/delete')); ?>"
                                                      style='display: none;'>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elnagar/php projects/Lawyer/resources/views/clientattachment/index.blade.php ENDPATH**/ ?>