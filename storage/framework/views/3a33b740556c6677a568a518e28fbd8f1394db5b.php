                        ...
                        <div class="panel panel-default panel-white core-box">
                            <div class="panel-body no-padding">
                                ...
                                <div class="padding-20 core-content">
                                    ...
                                    <span
                                        class="subtitle"> #  <?php echo e($users->count()); ?> </span>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default panel-white core-box">
                            <div class="panel-body no-padding">
                                ...
                                <div class="padding-20 core-content">
                                    ...
                                    <span
                                        class="subtitle"> <?php echo e($cases->count()); ?> </span>
                                </div>
                            </div>
                            <div class="panel-footer clearfix no-padding">
                        ...
                        <div class="panel panel-default panel-white core-box">
                            ...
                            <div class="panel-body no-padding">
                                ...
                                <div class="padding-20 core-content">
                                    ...
                                    <span
                                        class="subtitle">  <?php echo e($mohdreen->count()); ?>     </span>
                                </div>
                            </div>
                            <div class="panel-footer clearfix no-padding">
                ...
                <div class="row" >
                 ...
                 <div class="panel-body">
                            ...
                            <?php $__currentLoopData = $session; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><?php echo e($session->month); ?></td>
                                <td><?php echo e($session->case_Id); ?></td>  
                            <td>   <a id="shownotes" class="btn btn-xs btn-blue tooltips" data-placement="top"
                           data-original-title="show" data-session-Id="<?php echo e($session->id); ?>"><i class="fa fa-eye"></i></a></td>
                    ...
                    <div class="col-md-12">
                        ...
                        <thead class="black white-text">
                          ...
                          <?php $__currentLoopData = $sessionNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessionNo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <th scope="row"><?php echo e($sessionNo->id); ?></th> 
                              <td><?php echo e($sessionNo->session_date); ?></td>
                              <td><?php echo e($sessionNo->status); ?></td>
                              <td><?php echo e($sessionNo->month); ?></td>
                              <td><?php echo e($sessionNo->case_Id); ?></td>  
                    ...
                    <div class="col-md-12">
                        ...
                        <thead class="black white-text">
                          ...
                          <?php $__currentLoopData = $mohder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mohder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <th scope="row"><?php echo e($mohder->moh_Id); ?></th> 
                              <td><?php echo e($mohder->court_mohdareen); ?></td>
                              <td><?php echo e($mohder->paper_type); ?></td>
                              <td><?php echo e($mohder->session_Date); ?></td>
                              <td><?php echo e($mohder->case_number); ?></td>  
                              <td>   <a id="showMohdar" class="btn btn-xs btn-blue tooltips" data-placement="top"
                           data-original-title="show" data-moh-Id="<?php echo e($mohder->moh_Id); ?>"><i class="fa fa-eye"></i></a></td>
                            </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
...
<?php $__env->startSection('scriptDocument'); ?>
    ...
    UIButtons.init();
<?php $__env->stopSection(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LawerWeb\resources\views/home.blade.php ENDPATH**/ ?>