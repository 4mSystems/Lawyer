        ...
        <div class="main-navigation right-wrapper transition-right">
            ...
            <div class="user-profile border-top padding-horizontal-10 block">
                <div class="inline-block" style="margin-top: 20px;">
                    <img src="<?php echo e(url('/images/avatar.jpg')); ?>" alt="">
                </div>
                <div class="inline-block">
                    
                    <h1 class="text-justify"> &nbsp;&nbsp; <?php echo e(Auth::user()->name); ?> </h4>
...
<?php /**PATH /home/dgmevmh7hnpa/public_html/Lawyer/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>