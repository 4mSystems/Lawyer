<tr id="userRow{{$mohdar->moh_Id}}">
    ...
    <td class="hidden-xs center"><p id="paper_type{{$mohdar->moh_Id}}">{{$mohdar->paper_type}}</p></td>
    <td class="hidden-xs center"><p id="deliver_data{{$mohdar->moh_Id}}">{{$mohdar->deliver_data}}</p></td>
    ...
    <td class="center">
        <div class="visible-md visible-lg hidden-sm hidden-xs">
            ...
            <a id="editMohdar" class="btn btn-xs btn-blue tooltips" data-placement="top"
               data-original-title="{{trans('site_lang.public_edit_btn_text')}}" data-moh-Id="{{$mohdar->moh_Id}}"><i class="fa fa-edit"></i></a>
            <a id="deleteMohadr" data-moh-Id="{{$mohdar->moh_Id}}" class="btn btn-xs btn-red tooltips"
               data-placement="top"
               data-original-title="{{trans('site_lang.public_delete_text')}}"><i class="fa fa-times fa fa-white"></i></a>
            <a id="showMohdar" class="btn btn-xs btn-blue tooltips" data-placement="top"
               data-original-title="{{trans('site_lang.home_see_more')}}" data-moh-Id="{{$mohdar->moh_Id}}"><i class="fa fa-eye-slash"></i></a>
        </div>
