                ...
                <div class="toolbar row" style="direction:rtl;">
                    <div class="col-sm-12 hidden-xs">
                        <div class="page-header">
                            <h3 class="text-bold">{{trans('site_lang.client_attachments')}}</h3>
                        </div>
                    </div>
                </div>
                <!-- end: TOOLBAR -->
                    ...
                    <div class="col-md-12"><br>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <a href="{{url('clientattachment/'.$client_id.'/create')}}"
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-hover table-full-width"
                                    ...
                                    <tbody>
                                    @foreach($client_attachment as $case_attachment)
                                        <tr>
                                            ...
                                            <td class="hidden-xs center">
                                                @if(!empty($case_attachment->img_Url))
                                                    ...
                                                    @endphp
                                                    @if(! in_array( mime_content_type('uploads/client/attachments/'.$case_attachment->img_Url), $allowedMimeTypes))
                                                        <a href="{{url('uploads/client/attachments/'.$case_attachment->img_Url) }}"
                                                           target="_blank"> <img
                                                    ...
                                                    @else
                                                        <a href="{{url('uploads/client/attachments/'.$case_attachment->img_Url) }}"
                                                           target="_blank"> <img
                                                                src="{{url('uploads/client/attachments/'.$case_attachment->img_Url) }}"
                                            ...
                                            <td class="hidden-xs center"><a class='btn btn-raised btn-primary btn-sml'
                                                ...
                                                <form method="get" id='delete-form'
                                                      action="{{url('clientattachment/'.$case_attachment->id.'/delete')}}"
                                                      style='display: none;'>
                                                {{csrf_field()}}
                                                <!-- {{method_field('delete')}} -->
                                                </form>
