                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                {!! Form::model($attachment, ['url' => ['clientattachment/'.$attachment->id.'/update'] , 'method'=>'post' ,'files'=> true]) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <!-- <img
                                            src="{{url('uploads/client/attachments/'.$attachment->img_Url) }}"
                                            ...
                                            @if(!empty($attachment->img_Url))
                                                    ...
                                                    @endphp
                                                    @if(! in_array( mime_content_type('uploads/client/attachments/'.$attachment->img_Url), $allowedMimeTypes))
                                                        <a href="{{url('uploads/client/attachments/'.$attachment->img_Url) }}"
                                                           target="_blank"> <img
