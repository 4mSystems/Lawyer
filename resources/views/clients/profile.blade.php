                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                {{trans('site_lang.public_view_btn_text')}}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div id="createModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 align="center" style="margin:0;">{{trans('site_lang.add_notes')}}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                               ...
                                               value="{{ old('notes') }}" form="client_note"></textarea> 
                                    </div>
                                    </div>
                                </div>
                             </div> 
    ...
    <div id="edit_note_model" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 align="center" style="margin:0;">{{trans('site_lang.edit_notes')}}</h4>
                    </div>
                    <div class="card-body">
