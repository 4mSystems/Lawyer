...
[![Latest Stable Version](https://poser.pugx.org/geekcom/phpjasper/v/stable)](https://packagist.org/packages/geekcom/phpjasper-laravel)
...
Registre o provider PHPJasperServiceProvider, adicione a linha abaixo ao array:
