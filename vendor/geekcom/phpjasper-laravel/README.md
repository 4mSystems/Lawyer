...
[![Latest Stable Version](https://img.shields.io/packagist/v/geekcom/phpjasper.svg?style=flat-square)](https://packagist.org/packages/geekcom/phpjasper-laravel)
...
### Docs
[![Language-pt_BR](https://img.shields.io/badge/pt__BR-100%25-green.svg)](https://github.com/PHPJasper/phpjasper-laravel/blob/master/docs/pt_BR/LEIA-ME_pt_BR.md)
...
Generating *HTML* + *CSS* to make a *PDF*? That doesn't make any sense! :)
...
To register PHPJasperServiceProvider, add it to the array:
